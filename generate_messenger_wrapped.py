...
if __name__ == "__main__":
  ...
  print('\nGROUP CHATS')
  print('(Press ENTER to default to including group chat messages.)')
  ...
  print('\nPHRASE LENGTH')
  print('(Press ENTER to default to 4-word phrases.)')
  ...
  print('\nSHARE NAMES OR NUMBER OF MESSAGES')
  print('(Press ENTER to default to printing the NUMBER OF MESSAGES SENT BY instead of the NAMES OF your top 5 people.)')
  print('Would you like to display the names or the number of messages that your top 5 people sent?')
  share_names = input('Type "names" (with no quotation marks) for names; type anything else to display the number of messages instead:\n').lower()
